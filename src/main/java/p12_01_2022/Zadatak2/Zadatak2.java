...
public class Zadatak2 {
    public static void main(String[] args) {
       FizickoLice kupac = new FizickoLice("Jelena Alempijevic", "26564164696","15049857854212", false);
       FizickoLice prodavac = new FizickoLice("Milena Markovic", "25487456632","1208965785412", true);

       Ugovor u = new Ugovor("11.01.2022.",prodavac, kupac,25000,"Trg Kosovskih junara 11B");
